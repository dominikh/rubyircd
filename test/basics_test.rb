...
class BasicsTest < Test::Unit::TestCase
  ...
  def test_mode_and_userlist
    ...
    @client1.send_message 'MODE #testchannel +ö' # ignored
    @client1.send_message 'MODE #testchannel +v testuser2' # ignored
  ...
  def test_nickname_blacklist
    @client1.send_message 'NICK nazi33'
    @client1.assert_response ':localhost 432 testuser1 nazi33 :Nickname blacklisted'
  end
